...
const COLOR_MAP = {
  ...
  'nat': 'Natural', 'crm': 'Cream', 'creme': 'Creme', 'pnk': 'Pink', 'pur': 'Purple',
  'prp': 'Purple', 'org': 'Orange', 'orn': 'Orange', 'ylw': 'Yellow', 'olv': 'Olive',
  'olive': 'Olive', 'bur': 'Burgundy', 'mar': 'Maroon', 'marn': 'Maroon', 'ash': 'Ash',
  'slt': 'Slate', 'snd': 'Sand', 'khk': 'Khaki', 'kha': 'Khaki', 'choc': 'Chocolate',
  'chocolate': 'Chocolate', 'dkchoc': 'Dark Chocolate', 'vblk': 'Vintage Black',
  'vwht': 'Vintage White', 'vnvy': 'Vintage Navy', 'bkedg': 'Black Edge', 'sco': 'Scour',
  'scour': 'Scour', 'hth': 'Heather', 'oxf': 'Oxford', 'dkh': 'Dark Heather',
  'dkhgry': 'Dark Heather Grey', 'frn': 'Fern', 'frs': 'Forest', 'for': 'Forest',
  'forgrn': 'Forest Green', 'mus': 'Mustard', 'rst': 'Rust', 'cml': 'Camel',
  'sge': 'Sage', 'sag': 'Sage', 'lav': 'Lavender', 'dst': 'Dusty', 'slb': 'Slate Blue',
  'crl': 'Coral', 'mnt': 'Mint', 'mint': 'Mint', 'sky': 'Sky', 'ivr': 'Ivory',
  'ivy': 'Ivy', 'bge': 'Beige', 'beige': 'Beige', 'gld': 'Gold', 'gold': 'Gold',
  'trq': 'Turquoise', 'cha': 'Charcoal', 'chrcl': 'Charcoal', 'htg': 'Heather Grey',
  'lgr': 'Light Grey', 'dgr': 'Dark Grey', 'rbl': 'Royal Blue', 'ryl': 'Royal',
  'rylbl': 'Royal Blue', 'rybl': 'Royal Blue', 'lbl': 'Light Blue', 'dbl': 'Dark Blue',
  'dlb': 'Dusty Light Blue', 'arm': 'Army', 'cream': 'Cream', 'owht': 'Off White',
  'brg': 'Burgundy', 'brdx': 'Bordeaux', 'bor': 'Bordeaux', 'brown': 'Brown',
  'colbl': 'Columbia Blue', 'kel': 'Kelly Green', 'slv': 'Silver', 'tea': 'Teal',
  'purple': 'Purple', 'lpk': 'Light Pink', 'lpnk': 'Light Pink', 'cmnt': 'Cement',
  ...
  'nhblu': 'Neon Blue', 'npnk': 'Neon Pink', 'black': 'Black', 'white': 'White',
  'navy': 'Navy', 'seabl': 'Sea Blue', 'dolbl': 'Dolphin Blue', 'borg': 'Bright Orange',
  'bred': 'Bright Red', 'arc': 'Arctic', 'carblk': 'Carbon Black', 'coc': 'Cocoa',
  'icegry': 'Ice Grey', 'ind': 'Indigo', 'lmst': 'Limestone', 'mat': 'Matcha',
  'tau': 'Taupe'
};
  ...
  try {
    ...
    colorCodes.forEach(colorCode => {
      ...
      $('img').each((i, el) => {
        ...
        // Match pattern like "f97blk" or "hf-09ash" (with or without hyphen)
...
async function main() {
  console.log(`\n=== Scraping colors for ${hoodies.products.length} hoodies ===\n`);
        ...
        if (color.image) {
          ...
          if (!fs.existsSync(filepath)) {
            ...
            if (size > 0) {
              ...
              color.image = `/images/hoodies/colors/${filename}`;
            } else {
  ...
  fs.writeFileSync(hoodiesPath, JSON.stringify(updatedData, null, 2));
